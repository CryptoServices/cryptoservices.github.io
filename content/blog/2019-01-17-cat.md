...
* [Bleichenbacher (CRYPTO 1998)](http://archiv.infsec.ethz.ch/education/fs08/secsem/bleichenbacher98.pdf) also called the 1 million message attack, BB98, padding oracle attack on PKCS#1 v1.5, etc.
* [Klima et al. (CHES 2003)](https://eprint.iacr.org/2003/052)
* [Blei­chen­ba­cher’s At­tack Strikes Again: Brea­king PKCS#1 V1.5 In Xml En­cryp­ti­on (ESORICS 2012)](https://www.nds.rub.de/media/nds/veroeffentlichungen/2012/12/19/XMLencBleichenbacher.pdf)
* [Degabriele et al. (CT-RSA 2012)](https://eprint.iacr.org/2011/615.pdf)
* [Bardou et al. (CRYPTO 2012)](https://eprint.iacr.org/2012/417)
* [Cross-Tenant Side-Channel Attacks in PaaS Clouds (CCS 2014)](https://www.cs.unc.edu/~reiter/papers/2014/CCS1.pdf)
* [Revisiting SSL/TLS Implementations: New Bleichenbacher Side Channels and Attacks (USENIX 2014)](https://www.usenix.org/conference/usenixsecurity14/technical-sessions/presentation/meyer)
* [On the Security of TLS 1.3 and QUIC Against Weaknesses in PKCS#1 v1.5 Encryption (CCS 2015)](https://www.nds.rub.de/media/nds/veroeffentlichungen/2015/08/21/Tls13QuicAttacks.pdf)
* [DROWN (USENIX 2016)](https://drownattack.com/)
* [Return Of Bleichenbacher's Oracle Threat (USENIX 2018)](https://robotattack.org/)
* [The Dangers of Key Reuse: Practical Attacks on IPsec IKE (USENIX 2018)](https://www.usenix.org/system/files/conference/usenixsecurity18/sec18-felsch.pdf)
...
![The TLS 1.3 signature forgery attack using a TLS 1.2 server as Bleichenbacher oracle.](/images/cat-3.png)
...
![The TLS 1.3 attack downgrades the victim to an older version of TLS.](/images/cat/tls13downgrade.png)
...
![The Decryption Attack performs a new handshake with the server, using a modified encrypted premaster secret obtained from the victim’s `ChangeCipherSpec` message.](/images/cat/attack.png)
...
![The attack on TLS 1.2 modifies the client’s first packet to force an RSA key exchange.](/images/cat/tls12attack.png)
