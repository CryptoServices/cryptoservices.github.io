...
I'll have the input to my transaction be 1STC (Shitcoin; ICO is next week, check it out). I'd like
to print some money, so I set my output to be 8STC. I'll be generous and give the miner 4STC as my
...
And that's how confidential transactions work! If I want to send STC to someone, I can construct a
